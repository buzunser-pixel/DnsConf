...
[Игнорирование редиректов (опционально)](#игнорирование-редиректов-опционально)
...
## Игнорирование редиректов (опционально)


Добавьте домены в **переменную среды** `IGNORE_REDIRECT` через запятую **без пробела**, например: `instagram.com,twitch.com`
